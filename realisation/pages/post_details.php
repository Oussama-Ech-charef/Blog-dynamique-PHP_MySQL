...
<body>
    ...
    <section class="post_hero">
        ...
        <div class="post_hero_content">
            ...
            <div class="post_meta">
                <span class="meta_item"><i class="fa-regular fa-eye"></i> 
                    <?= htmlspecialchars($post['views']) ?></span>
                <span class="meta_item"><i class="fa-regular fa-comment"></i> 1 comment</span>
                <span class="meta_item"><i class="fa-regular fa-calendar"></i><?= date('F j, Y', strtotime($post['created_at'])) ?></span>
            </div>
        </div>
    </section>
                    ...
                    <div class="sidebar_card_info">
                        ...
                        <ul class="place_stats_list">
                            ...
                            <li>
                                ...
                                <div class="stat_text">
                                    <span>Views</span>
                                    <strong><?= htmlspecialchars($post['views']) ?></strong>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div class="stat_text">
                                    <span>Posted</span>
                                    <strong><?= date('F j, Y', strtotime($post['created_at'])) ?></strong>
                                </div>
                            </li>
                        </ul>
